...
from hyperdeck_control import TIMER_SLOTS          # noqa: E402
...
def test_end_to_end():
    with Stack() as s:
        ...
        # Der Dienst liefert immer alle Zeitplan-Plaetze, auch die ausgeschalteten.
        assert d["log_reset"] is True and len(d["timers"]) == TIMER_SLOTS
